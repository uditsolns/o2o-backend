...
class TripResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'driver_aadhaar' => $this->driver_aadhaar,
            'is_driver_license_verified' => $this->is_driver_license_verified,
            'is_driver_aadhaar_verified' => $this->is_driver_aadhaar_verified,
            // Vehicle
            ...
            'is_rc_verified' => $this->is_rc_verified,
            'is_verification_done' => $this->is_verification_done,
            ...
            'customer' => $this->whenLoaded('customer', fn() => [
                ...
                'iec_number' => $this->customer->iec_number,
                'primary_contact_name' => $this->customer->primary_contact_name,
                'primary_contact_email' => $this->customer->primary_contact_email,
                'primary_contact_mobile' => $this->customer->primary_contact_mobile,
            ...
            'tracking_points' => TripTrackingPointResource::collection($this->whenLoaded('trackingPoints')),
            'shipment_milestones' => TripShipmentMilestoneResource::collection($this->whenLoaded('shipmentMilestones')),
