...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('trip_shipment_milestones', function (Blueprint $table) {
            ...
            $table->enum('event_category', ['transport', 'equipment']);
            ...
            $table->string('vessel_mmsi', 20)->nullable();
            $table->string('voyage_number')->nullable();
            $table->string('vessel_operational_status', 50)->nullable();

            $table->string('mode_of_transport', 30)->nullable();
            $table->string('location_type')->nullable()
                ->comment('port_of_loading, transshipment, port_of_discharge');
            $table->decimal('local_time_offset', 4, 2)->nullable();
            $table->string('equipment_indicator', 10)->nullable()
